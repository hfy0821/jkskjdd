<template>
  <div class="event_warp">
    ...
    <div class="detailMsg" v-show="tabIndex === 1">
      <ul class="ul">
        <li
          ...
          v-if="
            checkRight(
              'emergencyHandleManagement:eventName',
              'emergencyEventManagement:eventName',
              'emergencyDistributionManagement:eventName'
            )
          "
        >
          <span>事件名称</span>
        ...
        <li
          v-if="
            checkRight(
              'emergencyHandleManagement:location',
              'emergencyEventManagement:location',
              'emergencyDistributionManagement:location'
            )
          "
        >
          <span>事发地址</span>
        ...
        <li
          v-if="
            checkRight(
              'emergencyHandleManagement:eventDescription',
              'emergencyEventManagement:eventDescription',
              'emergencyDistributionManagement:eventDescription'
            )
          "
        >
          <span>事件描述</span>
        ...
        <li
          v-if="
            checkRight(
              'emergencyHandleManagement:eventCategory',
              'emergencyEventManagement:eventCategory',
              'emergencyDistributionManagement:eventCategory'
            )
          "
        >
          <span>事件类别</span>
        ...
        <li
          v-if="
            checkRight(
              'emergencyHandleManagement:eventSource',
              'emergencyEventManagement:eventSource',
              'emergencyDistributionManagement:eventSource'
            )
          "
        >
          <span>事件来源</span>
        ...
        <li
          v-if="
            checkRight(
              'emergencyHandleManagement:area',
              'emergencyEventManagement:area',
              'emergencyDistributionManagement:area'
            )
          "
        >
          <span>所属区域</span>
        ...
        <li
          v-if="
            checkRight(
              'emergencyHandleManagement:affiliatedStreet',
              'emergencyEventManagement:affiliatedStreet',
              'emergencyDistributionManagement:affiliatedStreet'
            )
          "
        >
          <span>所属街道</span>
    ...
    <div class="btn" v-if="type == 1">
      <span
        @click="handClick(1)"
        v-if="checkRight('emergencyHandleManagement:supplementaryExplanation')"
        >处置情况</span
      >
      <span
        @click="handClick(2)"
        v-if="checkRight('emergencyHandleManagement:applyForKnot')"
        >申请办结</span
      >
      <!-- <span @click="handClick(10)" v-if="signData.isSign===0">签收</span> -->
    </div>
    <div class="btn assist" v-if="type == 2">
      <span
        @click="handClick(1)"
        v-if="checkRight('emergencyHandleManagement:supplementaryExplanation')"
        >处置情况</span
    ...
    <div class="btn" v-if="type == 3">
      <span
        @click="handClick(3)"
        v-if="checkRight('emergencyEventManagement:processingEdit')"
        >编辑</span
      >
      <span
        @click="handClick(4)"
        v-if="checkRight('emergencyEventManagement:processingWithdraw')"
        >撤回</span
      >
      <span
        @click="handClick(8)"
      ...
      <span
        ...
        v-if="
          checkRight(
            'emergencyEventManagement:processingSupplementaryExplanation'
          )
        "
        >处置情况</span
      >
    ...
    <div class="btn" v-if="type == 4">
      ...
      <span
        @click="handClick(5)"
        v-if="checkRight('emergencyEventManagement:repliedWithdraw')"
        >退回</span
      >
      <span
        @click="handClick(1)"
      ...
      <span
        @click="handClick(9)"
        v-if="checkRight('emergencyEventManagement:repliedSetUp')"
        >办结</span
      >
      <!-- <span @click="handClick(10)" v-if="signData.isSign===0">签收</span> -->
    </div>
    <!-- 草稿箱 -->
    <div class="btn" v-if="type == 6">
      <span
        @click="handClick(6)"
        v-if="checkRight('emergencyDistributionManagement:assign')"
        >指派</span
      >
      <span
        @click="handClick(3)"
        v-if="checkRight('emergencyDistributionManagement:edit')"
        >编辑</span
      >
      <span
        @click="handClick(7)"
        v-if="checkRight('emergencyDistributionManagement:delete')"
        >删除</span
      >
    </div>
  </div>
      ...
      if (data.success) {
        ...
        if (this.type == 1 || this.type == 2 || this.type == 5) {
          this.tabs = [
            ...
            {
              name: "事件进度",
              hide: !this.checkRight("emergencyHandleManagement:processing"),
            },
            {
              name: "附件信息",
              hide: !this.checkRight("emergencyHandleManagement:extInfo"),
            },
            {
              name: "处置情况",
              hide: !this.checkRight("emergencyHandleManagement:resultInfo"),
            },
            {
              name: "领导批示",
              hide: !this.checkRight(
                "emergencyHandleManagement:leadershipInstructions"
              ),
            },
          ];
          return;
        ...
        if (this.type == 3 || this.type == 4) {
          this.tabs = [
            ...
            {
              name: "事件进度",
              hide: !this.checkRight("emergencyEventManagement:processing"),
            },
            {
              name: "附件信息",
              hide: !this.checkRight("emergencyEventManagement:extInfo"),
            },
            {
              name: "处置情况",
              hide: !this.checkRight("emergencyEventManagement:resultInfo"),
            },
            {
              name: "领导批示",
              hide: !this.checkRight(
                "emergencyEventManagement:leadershipInstructions"
              ),
            },
          ];
          return;
        ...
        this.tabs = [
          ...
          {
            name: "事件进度",
            hide: !this.checkRight("emergencyDistributionManagement:progress"),
          },
          {
            name: "附件信息",
            hide: !this.checkRight("emergencyDistributionManagement:extInfo"),
          },
          {
            name: "处置情况",
            hide: !this.checkRight(
              "emergencyDistributionManagement:resultInfo"
            ),
          },
          { name: "领导批示", hide: 1 },
        ];
