...
export default {
  ...
  data() {
    return {
      ...
      edit: false,
      tabs: [],
      tabIndex: localStorage.getItem("cluesDetailTabIndex") / 1 || 1,
      formData: {
        address: "",
        districtsId: "",
        roadName: "",
  ...
  methods: {
    ...
    changeIndex(i) {
      const that = this;
      that.tabIndex = i;
      localStorage.setItem("cluesDetailTabIndex", i);
      this.$forceUpdate();
    },
    // 重新编辑
    reEdit() {
