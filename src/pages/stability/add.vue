      ...
      <div class="item">
        ...
        <div>
          <input
            ...
            readonly
            type="text"
            :value="formData.eventName&&formData.eventName.join(',')"
...
import { upload, addHandle, getHandleEventDetailByIdForApp } from "../../api/a";
export default {
  name: "reportedAdd",
  components: {
    multiSelect,
  ...
  data() {
    return {
      ...
      formData: {
        ...
        isTeamWork: 1,
        sourceType: 113,
        authName: "stabilityEvent:roleList",
  ...
  async created() {
    ...
    if (this.id) {
      ...
      if (data.success) {
        ...
        this.formData.parentAuthName = "stabilityEvent:eventManagement";
