  ...
  <div class="confirm_warp">
    ...
    <van-popup v-model="show">
      <div class="assist">
        ...
        <mt-checklist
          title="复选框列表"
          v-model="formData.assistName"
          :options="assistOption"
        >
        </mt-checklist>
        <!-- <div class="list">
					<van-checkbox v-for="(v,i) in myAssistList" :key="i" icon-size="20px" v-model="v.checked">{{v.name}}</van-checkbox>
				</div> -->
      </div>
    </van-popup>
  </div>
